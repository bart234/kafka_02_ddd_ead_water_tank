from app.db_access_layer.db_mid_layer import WaterTankFeaturesRepository
...
class TestWaterTankFeatures:
    def test_add_wt(self,db_test_session):
        self.repo = WaterTankFeaturesRepository(db_test_session)
    ...
    def test_get(self,db_test_session,add_dummy_wtf_to_db):
        ...
        self.repository = WaterTankFeaturesRepository(db_test_session)
